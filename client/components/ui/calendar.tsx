    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-transparent p-0 hover:bg-gray-100 border-gray-200 hover:border-gray-300 transition-colors",
        ),
        ...
        head_row: "flex mb-2",
        head_cell:
          "text-gray-500 rounded-md w-10 h-8 font-medium text-sm flex items-center justify-center",
        ...
        day_selected:
          "bg-blue-600 text-white hover:bg-blue-700 hover:text-white focus:bg-blue-700 focus:text-white rounded-md font-medium",
